...
export default function Navbar({ activePage = "home" }: NavbarProps) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
      {/* Desktop Nav */}
      <nav className="hidden lg:flex items-center justify-between px-8 xl:px-20 py-5 bg-[var(--bg-primary)]/50 backdrop-blur-xl w-full border-b border-white/[0.06]">
        {/* Logo */}
        ...
        <div className="flex items-center gap-2 xl:gap-3 shrink-0">
          <button
            ...
            aria-label="Share"
            className="flex items-center gap-2 px-3 xl:px-6 py-3 border border-[var(--gold)] text-[var(--gold)] text-[11px] font-bold tracking-[1px] hover:opacity-80 transition-opacity"
          >
            <Share2 size={14} />
          ...
          <a
            ...
            className="flex items-center gap-2 px-3 xl:px-6 py-3 border border-white/20 text-[var(--text-secondary)] text-[11px] font-bold tracking-[1px] hover:text-[var(--text-primary)] hover:border-white/40 transition-colors"
          >
          ...
          <Link
            href="/get-involved"
            className="px-4 xl:px-6 py-3 bg-[var(--gold)] text-[#111111] text-[11px] font-bold tracking-[1px] hover:opacity-90 transition-opacity whitespace-nowrap"
          >
            SUPPORT THE MISSION
          </Link>
        </div>
      ...
      {/* Mobile Nav */}
      <nav className="flex lg:hidden items-center justify-between px-5 py-4 bg-[var(--bg-primary)]/50 backdrop-blur-xl w-full border-b border-white/[0.06]">
      ...
      {/* Mobile Drawer */}
      {menuOpen && (
        <div className="flex lg:hidden flex-col bg-[var(--bg-primary)]/90 backdrop-blur-xl border-t border-[var(--border-default)]">
          {navLinks.map((link) => (
            <Link
              key={link.page}
              href={link.href}
